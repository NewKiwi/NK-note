<template>
  <transition name="k-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="k-time-panel k-popper"
      :class="popperClass">
      <div class="k-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
      ...
      <div class="k-time-panel__footer">
        <button
          type="button"
          class="k-time-panel__btn cancel"
          @click="handleCancel">取消</button>
        <button
          type="button"
          class="k-time-panel__btn"
