<template>
  <transition name="k-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="k-picker-panel k-date-range-picker k-popper"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="k-picker-panel__body-wrapper">
        <slot name="sidebar" class="k-picker-panel__sidebar"></slot>
        <div class="k-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="k-picker-panel__shortcut"
            v-for="shortcut in shortcuts"
            @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
        </div>
        <div class="k-picker-panel__body">
          <div class="k-date-range-picker__time-header" v-if="showTime">
            <span class="k-date-range-picker__editors-wrap">
              <span class="k-date-range-picker__time-picker-wrap">
                <k-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  placeholder="开始日期"
                  class="k-date-range-picker__editor"
                  :value="minVisibleDate"
                  @input.native="handleDateInput($event, 'min')"
                  @change.native="handleDateChange($event, 'min')" />
              </span>
              <span class="k-date-range-picker__time-picker-wrap" v-clickoutside="() => minTimePickerVisible = false">
                <k-input
                  size="small"
                  :disabled="rangeState.selecting"
                  placeholder="开始时间"
            ...
            <span class="k-icon-arrow-right"></span>
            <span class="k-date-range-picker__editors-wrap is-right">
              <span class="k-date-range-picker__time-picker-wrap">
                <k-input
                  size="small"
                  :disabled="rangeState.selecting"
              ...
              <span class="k-date-range-picker__time-picker-wrap" v-clickoutside="() => maxTimePickerVisible = false">
                <k-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="maxInput"
          ...
          <div class="k-picker-panel__content k-date-range-picker__content is-left">
            <div class="k-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="k-picker-panel__icon-btn k-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="k-picker-panel__icon-btn k-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="k-picker-panel__icon-btn k-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="k-picker-panel__icon-btn k-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="k-picker-panel__content k-date-range-picker__content is-right">
            <div class="k-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div class="k-picker-panel__footer" v-if="showTime">
        <k-button
          size="mini"
          type="text"
          class="k-picker-panel__link-btn"
          @click="handleClear">
          清空
        </k-button>
        <k-button
...
<script type="text/babel">
  ...
  export default {
    ...
    components: { TimePicker, DateTable, KInput, KButton }
  }
</script>
