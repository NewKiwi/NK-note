<template>
  <transition name="k-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="k-picker-panel k-date-picker k-popper k-popover"
      :class="[{
      ...
      <div class="k-picker-panel__body-wrapper">
        ...
        <div class="k-picker-panel__body">
          <div class="k-date-picker__time-header" v-if="showTime">
            <span class="k-date-picker__editor-wrap">
              <k-input
                placeholder="选择日期"
                :value="visibleDate"
                size="small"
            ...
            <span class="k-date-picker__editor-wrap" v-clickoutside="() => timePickerVisible = false">
              <k-input
                ref="input"
          ...
          <div
            class="k-date-picker__header"
            :class="{ 'k-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, KInput, KButton
    },
