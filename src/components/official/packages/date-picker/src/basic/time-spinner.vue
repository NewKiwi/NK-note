<template>
  <div class="k-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <k-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="k-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="k-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="k-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="k-time-spinner__arrow k-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="k-time-spinner__arrow k-icon-arrow-down"></i>
        <ul class="k-time-spinner__list" ref="hours">
          <li
            class="k-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="k-time-spinner__arrow k-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="k-time-spinner__arrow k-icon-arrow-down"></i>
        <ul class="k-time-spinner__list" ref="minutes">
          <li
            class="k-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="k-time-spinner__arrow k-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="k-time-spinner__arrow k-icon-arrow-down"></i>
        <ul class="k-time-spinner__list" ref="seconds">
          <li
            class="k-time-spinner__item"
...
<script type="text/babel">
  ...
  import RepeatClick from '../../../../src/utils/directives/repeat-click'

  export default {
    components: { KScrollbar },
