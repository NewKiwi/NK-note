    ...
    <span
      ...
      <i
        ...
        <i
          ...
          :style="decimalStyle"
          class="nk-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="nk-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>
  ...
  export default {
    ...
    props: {
      ...
      iconClasses: {
        type: Array,
        default() {
          return ['nk-icon-star-on', 'nk-icon-star-on', 'nk-icon-star-on']
        }
      },
      voidIconClass: {
        type: String,
        default: 'nk-icon-star-off'
      },
      disabledVoidIconClass: {
        type: String,
        default: 'nk-icon-star-on'
      },
      disabled: {
        type: Boolean,
        default: false
    ...
    methods: {
      ...
      setCurrentValue(value, event) {
        ...
        if (this.allowHalf) {
          ...
          if (hasClass(target, 'nk-rate__item')) {
            target = target.querySelector('.nk-rate__icon')
          }
          if (hasClass(target, 'nk-rate__decimal')) {
